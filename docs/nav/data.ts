...
export const NAV_DATA: NavData[] = [
  {
    ...
    items: [
      ...
      {
        icon: 'https://tool.educlouddata.com/static/img/logo-blue.d2ac6927.png',
        title: '个人工具',
        desc: '个人日常使用的工具',
        link: 'https://tool.educlouddata.com/',
      },
      {
        icon: '/icons/ico.svg',
        title: '在线ICO',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://zenvideo.gtimg.com/images/zenvideo_logo_80x80.png',
        title: '腾讯智影',
      ...
      {
        icon: 'https://tool.aionline.cc/favicon.ico',
        title: 'AI在线',
        link: 'https://tool.aionline.cc/',
      },
    ],
  },
  {
